...
rs = bs.query_history_k_data_plus(code,
    ...
    start_date='2019-01-01', end_date=endDate,
...
plt.rc('axes', axisbelow=True, xmargin=0, fc='w', ec='#800000', lw=1.5, labelcolor='#800000',unicode_minus=False)  # 坐标轴属性(置底，左边无空隙，背景色，边框色，线宽，文本颜色，中文负号修正)
...
left, width = 0.05, 0.9
ax1 = fig.add_axes([left, 0.22, width, 0.7])  # left, bottom, width, height
ax4 = fig.add_axes([left, 0.1, width, 0.7], sharex=ax1)  # 共享ax1轴
# ax4 = fig.add_axes([left, 0.1, width, 0.8])  # 共享ax1轴
